...
export default function ReceivingRefundingFeesPage({
  resident = {},
  facility = {},
  signatures = {},
  onSignatureChange,
  ...
  const guardianName = signatures.guardian_name || resident.guardian_name || "";
    ...
    <div className="disclosure-document-page">
      <div className="disclosure-document-header">
        <div>
          ...
          <h1>Receiving and Refunding Client Fees</h1>
          <p>{facilityName}</p>
        </div>
      ...
      <div className="disclosure-document-body">
        <h2>Receiving and Refunding Client Fees</h2>

        <p>
          Upon discharge, voluntary or involuntary from {facilityName}, all fees
          that were paid and services were not rendered shall receive a refund by
          company check within seven (7) business days of the last date of
          service provided. Fees will be pro-rated based on the date of
          discharge. All clients or designated representatives will receive a
          30-day written notification of changes in any fees affecting their
          treatment.
        </p>

        <p>Your signature below indicates your understanding of the above policy.</p>
