  ...
  return (
    <div className="disclosure-document-page">
      ...
      <div className="disclosure-document-body">
        ...
        <p>
          The Resident’s rights are documented in your copy of the Resident
          Handbook. Please review your rights in collaboration with the staff
          member conducting your orientation.
        </p>

        <p>
          Your signature below indicates that you understand and have received
          your patient rights.
        </p>
